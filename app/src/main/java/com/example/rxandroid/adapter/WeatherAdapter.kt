...
class WeatherAdapter(private val dailies: List<DayEntity>) : RecyclerView.Adapter<WeatherAdapter.ResponseHolder>() {

    class ResponseHolder(private val binding: ItemRecyclerViewBinding, private val context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ResponseHolder =
        ResponseHolder(ItemRecyclerViewBinding.inflate(LayoutInflater.from(parent.context), parent, false), parent.context)
